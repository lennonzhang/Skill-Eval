...
const translations = {
  en: {
    ...
    "image.browserCacheCors": "The remote image host blocked browser CORS access; this is not a LAN service API CORS issue.",
  ...
  zh: {
    ...
    "image.browserCacheCors": "远程图片源站不允许浏览器跨域读取；这不是当前局域网服务 API 的跨域问题。",
